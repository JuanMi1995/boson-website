...
<h3><img src="imagenes/ubica.png" width="30px"/> Ubicación</h3>
...
<h3><img src="imagenes/telefono.png" width="30px"/> Telefonos</h3>
<table width="100%" border="0" cellspacing="5" cellpadding="5" class="table">
<tr>
<td>
<?php 
...
// Tel��fonos
$consulta = mysqli_query($conexion, "SELECT * FROM info WHERE tipo = 'telefono'"); 
while ($re = mysqli_fetch_array($consulta)) { 
$telefono = preg_replace('/\D/', '', $re['nombre']); // eliminar espacios, guiones, etc.
?>
    <a href="tel:<?php echo $telefono; ?>">
        <h4 style="color:black;"> <?php echo $re['nombre']; ?></h4>
    </a>
    <br />
<?php } ?>
...
<?php 
// WhatsApp
$consulta = mysqli_query($conexion, "SELECT * FROM info WHERE tipo = 'whatsapp'"); 
while ($re = mysqli_fetch_array($consulta)) { 
?>
    <a href="https://wa.me/52<?php echo $re['link']; ?>" target="_blank">
      <h4 style="color:black;">  WhatsApp: <?php echo $re['nombre']; ?></h4>
    </a>
    <br />
<?php } ?>
</td>
...
<h3><img src="imagenes/mail.png" width="30px"/> e-mail</h3>
<table width="100%" border="0" cellspacing="5" cellpadding="5" class="table">
<tr>
<td>
...
<div class=" col-xs-12  col-sm-12  col-md-6  col-md-offset-1  text-left ">
<h3>Dudas y comentarios </h3>
<form action="contacto-2.php" method="post">
...
<div class=" col-xs-12  col-sm-12  col-md-12 col-lg-12  text-left ">
<?php include("conectarse.php");$consulta = mysqli_query($conexion,"select * from info where tipo ='mapa'"); while($re=mysqli_fetch_array($consulta)){ ?>
<?php echo $re['nombre'];?>
<?php } ?>
</div> 
