...
<head>
<meta charset="UTF-8">
<meta name="description" content="Grupo Boson, Ingeniería 4.0, Automatizaciones, Tableros, Soluciones, Calidad de Energía y proyectos de ingenieria en todo el bajio"/>
<meta name="keywords" content="Ingeniería 4.0 Automatizacion Tableros Proyectos de ingenieria Calidad de Energía"/>
<meta name="keyphrases" content="Ingeniería 4.0 Automatizacion Tableros Proyectos de ingenieria Calidad de Energía"/>
...
$clave = $_GET['cve'];
$consulta = mysqli_query($conexion,"select * from contenidos where seccion='$clave' and estado='activo' limit 1");
...
include("conectarse.php");
$clave = $_GET['cve'];
$consulta = mysqli_query($conexion,"select * from categorias where Menu='$clave' and estado='activo' limit 1");
while($re=mysqli_fetch_array($consulta)){ ?> 
...
include("conectarse.php");
$clave = $_GET['cve'];
$consulta = mysqli_query($conexion,"select * from contenidos where seccion='$clave' and estado='activo' order by id");
while($re=mysqli_fetch_array($consulta)){ ?> 
  ...
  <tr>
    ...
    <div id="<?php echo $re['id'];?>"> </div>
      <tr>
        ...
        <td width="40%" valign="top"><img src="imagenes/<?php echo $re['foto'];?>" width="100%" /></td>
      </tr>
    </table>

   <?php echo $re['divicion'];?> 
